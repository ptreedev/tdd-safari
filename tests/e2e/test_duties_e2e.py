...
def test_new_duty_form_renders(page: Page):
    page.goto("/duties/new")
...
def test_user_can_add_a_new_duty(page: Page):
    add_duty(page)
...
def test_user_can_navigate_to_all_pages(page: Page):
    page.goto("/")
...
def test_user_sees_error_message_on_duplicate_duty(page: Page):
    add_duty(page)
